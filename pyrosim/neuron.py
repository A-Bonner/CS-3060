    ...
    def Update_Hidden_Or_Motor_Neuron(self, neurons, synapses):
        ...
        for syn in synapses:
            if syn[1] is self.Get_Name():
                ...
                preVal = neurons[syn[0]].Get_Value()
                self.Allow_Presynaptic_Neuron_To_Influence_Me(currWeight, preVal)
        self.Threshold()

    def Allow_Presynaptic_Neuron_To_Influence_Me(self, weight, preVal):
        self.Add_To_Value(weight * preVal)